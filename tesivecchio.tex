...
\usepackage[a4paper,top=4.25cm,bottom=3.75cm,left=3cm,right=3cm]{geometry}
...
siano: $A$ generico elemento dell' algebra, 
$R$ generico elemento del gruppo,  
$\dot{R}$ generico elemento di $T_{R}G$,
$M$ generico elemento del duale dell'algebra, risulta:
\begin{figure}[!h]
\centering
\mbox{%
...
\mbox{%
		...
		\begin{minipage}{.50\textwidth}	
		\includegraphics[width=7cm,keepaspectratio]{immagini/Capitolo_III/rotazioneattiva}
		\label{fig:rotattiva}
		\end {minipage}
...
\bibitem{Holm}Holm Darryl D.; Schmah Tanya; Stoica Cristina \, \emph{Geometric Mechanics and Symmetry}
\bibitem{Ratiu}Marsden Jerrold E. \, , Ratiu Tudor S. \, \emph{Introduction to Mechanics and Symmetry}, 2nd.ed
\bibitem{Corben} Corben H. C. \, , Stehle Philip \emph{Classical Mechanics}, 2nd.ed.
\bibitem{lagrange} articolo di lagrange
\end{thebibliography}
\end{document}
